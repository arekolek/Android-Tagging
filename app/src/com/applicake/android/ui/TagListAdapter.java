...
public class TagListAdapter extends BaseAdapter implements OnTagChangeListener {
  ...
  /**
   * Sets data source (ArrayList of tags) for this adapter, additionally allows
   * to disable so called present tags which could have been previously added by
   * the user and we want them to be grayed out
   * 
   * @param tags
   *          ArrayList of tags
   * @param presentTags
